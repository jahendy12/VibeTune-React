...
class Playlists extends Component {
    ...
    getPlaylists = async () => {
        ...
        const response = await fetch('https://vibetune.herokuapp.com/playlists')
    ...
    deletePlaylist = async (id) => {
        ...
        const response = await fetch(`https://vibetune.herokuapp.com/playlists/${id}`, {
            method: 'DELETE'
        })
    ...
    postNewPlaylist = async (playlist) => {
        ...
        const response = await fetch('https://vibetune.herokuapp.com/playlists/add', {
            method: 'POST',
            mode: 'cors',
    ...
    updatePlaylist = async (playlist) => {
        ...
        const response = await fetch(`https://vibetune.herokuapp.com/playlists/${_id}`, {
            method: 'POST',
            mode: 'cors',
            headers: { 'Content-Type': 'application/json' },
