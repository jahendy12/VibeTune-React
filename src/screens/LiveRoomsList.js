...
class Liverooms extends Component {
    ...
    getLiverooms = async () => {
        ...
        const response = await fetch('https://vibetune.herokuapp.com/liverooms')
    ...
    deleteLiveroom = async (id) => {
        ...
        const response = await fetch(`https://vibetune.herokuapp.com/liverooms${id}`, {
            method: 'DELETE'
        })
    ...
    postNewLiveroom = async (liveroom) => {
        ...
        const response = await fetch('https://vibetune.herokuapp.com/liverooms/add', {
            method: 'POST',
            mode: 'cors',
    ...
    updateLiveroom = async (liveroom) => {
        ...
        const response = await fetch(`https://vibetune.herokuapp.com/liverooms/${_id}`, {
            method: 'POST',
            mode: 'cors',
            headers: { 'Content-Type': 'application/json' },
